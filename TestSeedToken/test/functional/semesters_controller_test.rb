...
class SemestersControllerTest < ActionController::TestCase
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post :create, semester: { maximum: @semester.maximum, term: @semester.term, units: @semester.units, year: @semester.year }
    end
  ...
  test "should update semester" do
    put :update, id: @semester, semester: { maximum: @semester.maximum, term: @semester.term, units: @semester.units, year: @semester.year }
    assert_redirected_to semester_path(assigns(:semester))
  end
